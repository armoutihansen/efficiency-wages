...
log using outputs/logs/stata_main_tables.log, replace text

tempname results
postfile `results' str12 table_id str8 model str48 term double coefficient std_error fit_stat observations using outputs/tables/main_tables_results.dta, replace
...
use outputs/tables/main_tables_results.dta, clear
export delimited using outputs/tables/main_tables_results.csv, replace
