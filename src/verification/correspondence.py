...
ARTIFACTS = [
    ...
    Artifact("Supplement Tables A.2-A.3", "src/analysis/tables_appendix.do", "results/appendix/tables/", "generated"),
    Artifact("Supplement Tables A.4-A.9", "src/analysis/tables_appendix.do", "results/appendix/tables/", "generated"),
